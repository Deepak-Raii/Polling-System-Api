...
Methods         POST 
*/
// http://localhost:9000/api/v1/questions/create
...
Methods        POST 
*/
// http://localhost:9000/api/v1/questions/id/options/create
module.exports.createOption = async (req, res) => {
    ...
    try {
        ...
        if (question) {
            ...
            option.link_to_vote = "http://localhost:9000/api/v1/options/" + option._id + "/addVote";
...
Methods        GET 
*/
// http://localhost:9000/api/v1/questions/id
...
Methods        DELETE
*/
// http://localhost:9000/api/v1/questions/id/delete
